...
def tip_calculator():
    ...
    tip_percentage_negative = 'Please input a value greater for tip percentage.\n'
    tip_percentage_error = 'Sorry, I need an integer for the tip\n'

    tax_percentage_question = "How much is the sales tax?\n(Please input a positive integer (ie. 20 for 20%) or hit 'Enter' to use 10%)\nDefault value is 10%\n"
    tax_percentage_negative = 'Please input a value greater than 0 for tax percentage or hit enter to use default value of 10%\n'
    tax_percentage_error = 'Sorry, I need an integer for the tax\n'
    ...
    while run_calc:
        ...
        tax_percentage = get_tax_percentage(
            tax_percentage_question, tax_percentage_negative, tax_percentage_error
        )

        # calculate the bill per person
        bill_per_person = calculate_tip(
            party_size, tip_percentage, tax_percentage, bill_pre_tip)

        # print the values and outcome
        print_output(bill_pre_tip, tip_percentage, tax_percentage,
